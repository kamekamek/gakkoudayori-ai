...
import 'package:yutori_kyoshitu/features/layout/presentation/pages/enhanced_editor_layout.dart';
...
class AppRouter {
  ...
  final Map<String, WidgetBuilder> routes = {
    ...
    '/home': (context) => const EnhancedEditorLayout(), // 新しいエディタレイアウトを使用
    '/legacy-home': (context) =>
        const MainLayoutPage(), // 古い実装はlegacyとしてアクセス可能に
