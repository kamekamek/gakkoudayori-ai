...
class PdfDownloadService {
  ...
  /// WebブラウザでPDFをダウンロード
  static Future<void> _downloadPdfWeb(Uint8List pdfBytes, String fileName) async {
    try {
  ...
  static String _generateFileName(String? title) {
    ...
    final dateString = now.toIso8601String().substring(0, 19).replaceAll(RegExp(r'[:-]'), '').replaceAll('T', '_');
